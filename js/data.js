...
const PRODUCTS = [
  // Souvenir & ATK
  {
    ...
    nama: "Pulpen Custom Logo",
    deskripsi:
      "Pulpen plastik berkualitas dengan sablon logo perusahaan. Cocok untuk souvenir rapat, seminar, dan paket goodie bag. Minimal pemesanan menyesuaikan stok.",
    harga: "Rp 4.500",
    satuan: "per pcs",
    gambar: "https://placehold.co/400x300/0A2A5E/ffffff?text=Pulpen+Custom",
  },
  {
    id: "sou-002",
    kategori: "souvenir-atk",
    ...
    deskripsi:
      "Tumbler stainless steel 500ml, bisa custom logo. Tahan panas dan dingin, cocok untuk gift karyawan atau peserta acara.",
    harga: "Rp 45.000",
    satuan: "per pcs",
    gambar: "https://placehold.co/400x300/4A90D9/ffffff?text=Tumbler+500ml",
  },
  {
    id: "sou-003",
    kategori: "souvenir-atk",
    subKategori: "ATK",
    nama: "Notebook A5 Hardcover",
    deskripsi:
      "Notebook A5 hardcover 80 lembar. Bisa ditambahkan sablon cover sesuai identitas instansi atau event.",
    harga: "Rp 18.000",
    satuan: "per pcs",
    gambar: "https://placehold.co/400x300/0A2A5E/ffffff?text=Notebook+A5",
  },
  {
    id: "sou-004",
    kategori: "souvenir-atk",
    ...
    deskripsi:
      "Paket alat tulis kantor berisi pulpen, spidol, sticky notes, dan map folder. Siap kirim sesuai kebutuhan pengadaan kantor.",
    harga: "Rp 75.000",
    satuan: "per paket",
    gambar: "https://placehold.co/400x300/4A90D9/ffffff?text=Paket+ATK",
  },
